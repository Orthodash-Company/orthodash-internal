...
export function SimpleHeader() {
  ...
  return (
    <header className="fixed top-4 left-4 right-4 z-50">
      <div className="backdrop-blur-xl bg-white/90 border border-gray-200 rounded-2xl shadow-xl">
            ...
            <div className="flex items-center space-x-3">
              ...
              {user && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent 
                    align="end" 
                    className="w-64 backdrop-blur-xl bg-white/95 border border-gray-200 shadow-2xl rounded-xl"
                  >

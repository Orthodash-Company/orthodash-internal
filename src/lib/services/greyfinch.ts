...
export class GreyfinchService {
  ...
  async pullBasicCounts(userId: string) {
    try {
      ...
      // Use the exact field names from Greyfinch API documentation
      try {
        console.log('Attempting to get basic counts with correct field names...')
        
        // Get patient count using correct field name
        try {
        ...
        // Get lead count using correct field name
        try {
        ...
        // Get appointment count using correct field name
        try {
        ...
        // Get booking count using correct field name
        try {
        ...
        // Get location names using correct field name
        try {
